...
const CaseStudy = () => {
  ...
  return (
    <>
      <div onClick={() => navigate('/casestudydetail-cococola')} className="flex items-center flex-row justify-center max-sm:hidden cursor-pointer">
        <div className="border-[1px] shadow-lg border-slate-900 rounded-xl flex flex-row w-3/4 items-center h-60 p-20 mt-10">
          ...
          <div className="flex flex-col space-y-40 -mr-14">
      ...
      <div onClick={() => navigate('/casestudydetail-cococola')} className='flex flex-col items-center justify-center space-y-5'>
