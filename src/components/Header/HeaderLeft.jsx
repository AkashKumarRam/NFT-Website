...
const HeaderLeft = () => {
  return (
    <div className='mt-28 ml-24 main-header-left'>
       ...
       <p className='font-hero text-indigo-600 mt-4 text-lg sub-text max-sm:ml-11'>Leverage NFTs to transform customer engagement and <br/> establish a powerful community-driven brand presence with <br/> Hexatick's comprehensive NFT management solution.</p>
      ...
      <Link to='form' spy={true} smooth={true} offset={10} duration={400} className='mt-12 max-sm:mt-20 font-hero underline underline-offset-4 text-sm text-indigo-600 cursor-pointer'>Contact Sales</Link>
    </div>    
  )
}
