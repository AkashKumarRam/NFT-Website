...
const BrandDetails = () => {
  return (
   <div className='mt-2 w-full flex items-center justify-center p-5'>
     <div className='flex flex-row space-x-12 bg-[#F2F9FF] items-center justify-between h-[20rem] w-[64.4rem]'>
       ...
       <div className='flex- felx-col space-y-4'>
            <h2 className='text-3xl font-bold'>Make your</h2>
            <h2 className='text-3xl font-bold'>brand stand out</h2>
