...
const SingleKeyPoints = () => {
  return (
    <div className="mt-10 flex flex-row space-x-14 items-center max-sm:space-y-10 max-sm:space-x-0 justify-center max-sm:flex max-sm:flex-col max-sm:justify-center max-sm:items-center">
      <div className="flex flex-col items-center justify-between space-y-2 max-sm:flex max-sm:flex-col max-sm:justify-center max-sm:items-center">
        <img className="h-60" src={Launch} alt="Launch" />
        <div className="flex flex-col items-center justify-center">
          <h3 className="font-header text-2xl mt-5">Deploy NFT in Click</h3>
          <p className=" text-lg mt-2">
            Just add collection details and click{" "}
          </p>
      ...
      <div className="flex flex-col items-center justify-between">
        ...
        <div className="flex flex-col items-center justify-center max-sm:text-center">
          ...
          <p className=" text-lg mt-2">
            Copy API Endpoint and API Key from
          </p>
      ...
      <div className="flex flex-col items-center justify-between space-y-2">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="text-lg mt-2">
            Call APIs from your business logics to{" "}
          </p>
