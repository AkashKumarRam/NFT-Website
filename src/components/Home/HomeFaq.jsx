    ...
    <div className="mt-20">
      ...
      <div className="mt-14 flex flex-col items-center ">
        ...
        <FaqBox
          ...
          answer="Your brand's NFT are managed by Hexarare
           Cloud service thus can be managed with simple REST APIs. Brands can trigger Hexarare
           APIs from within your product according to their business logic."
        />
        <FaqBox
